...
function callreservation() {
	...
	var callconsciousness = document.dtcallinfoForm.consciousness.value;
	var callmeal = document.dtcallinfoForm.care_meal_yn.value;
	var calltoilet = document.dtcallinfoForm.care_toilet.value;
	var callparalysis = document.dtcallinfoForm.state_paralysis.value;
	var callmobility = document.dtcallinfoForm.state_mobility.value;
	var callbedsore = document.dtcallinfoForm.bedsore_yn.value;
	var callsuction = document.dtcallinfoForm.suction_yn.value;
	var calloutpatient = document.dtcallinfoForm.outpatient_yn.value;
	var callnight = document.dtcallinfoForm.care_night_yn.value;
	
	if(!callconsciousness || !callmeal || !calltoilet || !callparalysis || !callmobility || !callbedsore || !callsuction || !calloutpatient || !callnight) {
		alert("모든 항목을 입력해주세요");
		return false;
	} else {
...
<button type="button" onclick="recallcheck();">다시선택</button>
<button type="button" onclick="updatecall();">기본정보수정</button>
</form>

<h3> <%=tname %>님의 상세정보를 입력해주세요</h3>
<form name="dtcallinfoForm" method="post">
...
<tr><td>
<% if(consciousness.equals("의식 있음")) { %>
<input type="radio" id="con_y" name="consciousness" value="의식 있음" checked>
	...
	<input type="radio" id="con_n" name="consciousness" value="의식 없음">
		<label for="con_n">의식 없음</label> <% } else if(consciousness.equals("의식은 있으나 의사소통 어려움")) { %>
		<input type="radio" id="con_y" name="consciousness" value="의식 있음">
		<label for="con_y">의식 있음</label>
	<input type="radio" id="difficult_com" name="consciousness" value="의식은 있으나 의사소통 어려움" checked>
		<label for="difficult_com">의식은 있으나 의사소통 어려움</label>
	<input type="radio" id="con_n" name="consciousness" value="의식 없음">
		<label for="con_n">의식 없음</label> <% } else { %>
		<input type="radio" id="con_y" name="consciousness" value="의식 있음">
		<label for="con_y">의식 있음</label>
	<input type="radio" id="difficult_com" name="consciousness" value="의식은 있으나 의사소통 어려움" >
		<label for="difficult_com">의식은 있으나 의사소통 어려움</label>
	<input type="radio" id="con_n" name="consciousness" value="의식 없음" checked>
...
<% if(care_meal_yn.equals("스스로 식사 가능")) { %>
<input type="radio" id="meal_self" name="care_meal_yn" value="스스로 식사 가능" checked>
	...
	<input type="radio" id="injection" name="care_meal_yn" value="주사를 통한 정맥영양">
		<label for="injection">주사를 통한 정맥영양</label> <% } else if(care_meal_yn.equals("식사 보조 필요함")) { %>
		<input type="radio" id="meal_self" name="care_meal_yn" value="스스로 식사 가능" >
		<label for="meal_self">스스로 식사 가능</label>
	<input type="radio" id="meal_assistance" name="care_meal_yn" value="식사 보조 필요함" checked>
		<label for="meal_assistance">식사 보조 필요함</label>
	<input type="radio" id="Feeding" name="care_meal_yn" value="경관영양(피딩)">
		<label for="Feeding">경관영양(피딩)</label>
	<input type="radio" id="injection" name="care_meal_yn" value="주사를 통한 정맥영양">
		<label for="injection">주사를 통한 정맥영양</label> <% } else if(care_meal_yn.equals("경관영양(피딩)")) { %>
		<input type="radio" id="meal_self" name="care_meal_yn" value="스스로 식사 가능" >
		<label for="meal_self">스스로 식사 가능</label>
	<input type="radio" id="meal_assistance" name="care_meal_yn" value="식사 보조 필요함" >
		<label for="meal_assistance">식사 보조 필요함</label>
	<input type="radio" id="Feeding" name="care_meal_yn" value="경관영양(피딩)" checked>
		<label for="Feeding">경관영양(피딩)</label>
	<input type="radio" id="injection" name="care_meal_yn" value="주사를 통한 정맥영양">
		<label for="injection">주사를 통한 정맥영양</label>  <% } else { %>
		<input type="radio" id="meal_self" name="care_meal_yn" value="스스로 식사 가능" >
		<label for="meal_self">스스로 식사 가능</label>
	<input type="radio" id="meal_assistance" name="care_meal_yn" value="식사 보조 필요함" >
		<label for="meal_assistance">식사 보조 필요함</label>
	<input type="radio" id="Feeding" name="care_meal_yn" value="경관영양(피딩)" >
		<label for="Feeding">경관영양(피딩)</label>
	<input type="radio" id="injection" name="care_meal_yn" value="주사를 통한 정맥영양" checked>
...
<tr> <td>
<% if(care_toilet.equals("스스로 화장실 이용")) { %>
<input type="radio" id="toilet_self" name="care_toilet" value="스스로 화장실 이용" checked>
	...
	<input type="radio" id="stoma" name="care_toilet" value="장루/요루">
		<label for="stoma">장루/요루</label><% } else if(care_toilet.equals("동행하여 화장실 이용")) { %>
		<input type="radio" id="toilet_self" name="care_toilet" value="스스로 화장실 이용" >
		<label for="toilet_self">스스로 화장실 이용</label>
	<input type="radio" id="toilet_assistance" name="care_toilet" value="동행하여 화장실 이용" checked>
		<label for="toilet_assistance">동행하여 화장실 이용</label>
	<input type="radio" id="diapers" name="care_toilet" value="기저귀">
		<label for="diapers">기저귀</label>
	<input type="radio" id="foley_catheter" name="care_toilet" value="소변줄">
		<label for="foley_catheter">소변줄</label>
	<input type="radio" id="stoma" name="care_toilet" value="장루/요루">
		<label for="stoma">장루/요루</label> <% } else if(care_toilet.equals("기저귀")) { %>
			<input type="radio" id="toilet_self" name="care_toilet" value="스스로 화장실 이용" >
		<label for="toilet_self">스스로 화장실 이용</label>
	<input type="radio" id="toilet_assistance" name="care_toilet" value="동행하여 화장실 이용" >
		<label for="toilet_assistance">동행하여 화장실 이용</label>
	<input type="radio" id="diapers" name="care_toilet" value="기저귀" checked>
		<label for="diapers">기저귀</label>
	<input type="radio" id="foley_catheter" name="care_toilet" value="소변줄">
		<label for="foley_catheter">소변줄</label>
	<input type="radio" id="stoma" name="care_toilet" value="장루/요루"> 
		<label for="stoma">장루/요루</label> <% } else if(care_toilet.equals("소변줄")) { %>
		<input type="radio" id="toilet_self" name="care_toilet" value="스스로 화장실 이용" >
		<label for="toilet_self">스스로 화장실 이용</label>
	<input type="radio" id="toilet_assistance" name="care_toilet" value="동행하여 화장실 이용" >
		<label for="toilet_assistance">동행하여 화장실 이용</label>
	<input type="radio" id="diapers" name="care_toilet" value="기저귀" >
		<label for="diapers">기저귀</label>
	<input type="radio" id="foley_catheter" name="care_toilet" value="소변줄" checked>
		<label for="foley_catheter">소변줄</label>
	<input type="radio" id="stoma" name="care_toilet" value="장루/요루"> 
		<label for="stoma">장루/요루</label>  <% } else { %>
		<input type="radio" id="toilet_self" name="care_toilet" value="스스로 화장실 이용" >
		<label for="toilet_self">스스로 화장실 이용</label>
	<input type="radio" id="toilet_assistance" name="care_toilet" value="동행하여 화장실 이용" >
		<label for="toilet_assistance">동행하여 화장실 이용</label>
	...
	<input type="radio" id="foley_catheter" name="care_toilet" value="소변줄" >
		<label for="foley_catheter">소변줄</label>
	<input type="radio" id="stoma" name="care_toilet" value="장루/요루" checked> 
...
<tr> <td>
<% if(state_paralysis.equals("전신마비")) { %>
<input type="radio" id="general" name="state_paralysis" value="전신마비" checked>
	...
	<input type="radio" id="ps_n" name="state_paralysis" value="없음">
		<label for="ps_n">없음</label> <% } else if(state_paralysis.equals("편마비")) { %>
<input type="radio" id="general" name="state_paralysis" value="전신마비" >
		<label for="general">전신마비</label>
	<input type="radio" id="hemiplegia" name="state_paralysis" value="편마비" checked>
		<label for="hemiplegia">편마비</label>
	<input type="radio" id="ps_n" name="state_paralysis" value="없음">
		<label for="ps_n">없음</label>	 <% } else { %>
	<input type="radio" id="general" name="state_paralysis" value="전신마비" >
		<label for="general">전신마비</label>
	<input type="radio" id="hemiplegia" name="state_paralysis" value="편마비" >
		<label for="hemiplegia">편마비</label>
	<input type="radio" id="ps_n" name="state_paralysis" value="없음" checked>
...
<tr> <td>
<% if(state_mobility.equals("스스로 걸을 수 있음")) { %>
<input type="radio" id="mobility_self" name="state_mobility" value="스스로 걸을 수 있음" checked>
	...
	<input type="radio" id="mobility_n" name="state_mobility" value="움직일 수 없음">
		<label for="mobility_n">움직일 수 없음</label> <% } else if(state_mobility.equals("지팡이 혹은 휠체어 보조 필요")) { %>
<input type="radio" id="mobility_self" name="state_mobility" value="스스로 걸을 수 있음" >
		<label for="mobility_self">스스로 걸을 수 있음</label>
	<input type="radio" id="cw_assistance" name="state_mobility" value="지팡이 혹은 휠체어 보조 필요" checked>
		<label for="cw_assistance">지팡이 혹은 휠체어 보조 필요</label>
	<input type="radio" id="only_bed" name="state_mobility" value="침대에서만 움직임이 가능">
		<label for="only_bed">침대에서만 움직임이 가능</label>
	<input type="radio" id="mobility_n" name="state_mobility" value="움직일 수 없음">
		<label for="mobility_n">움직일 수 없음</label>  <% } else if(state_mobility.equals("침대에서만 움직임이 가능")) { %> 
<input type="radio" id="mobility_self" name="state_mobility" value="스스로 걸을 수 있음" >
		<label for="mobility_self">스스로 걸을 수 있음</label>
	<input type="radio" id="cw_assistance" name="state_mobility" value="지팡이 혹은 휠체어 보조 필요" >
		<label for="cw_assistance">지팡이 혹은 휠체어 보조 필요</label>
	<input type="radio" id="only_bed" name="state_mobility" value="침대에서만 움직임이 가능" checked>
		<label for="only_bed">침대에서만 움직임이 가능</label>
	<input type="radio" id="mobility_n" name="state_mobility" value="움직일 수 없음">
		<label for="mobility_n">움직일 수 없음</label>  <% } else { %>
<input type="radio" id="mobility_self" name="state_mobility" value="스스로 걸을 수 있음" >
		<label for="mobility_self">스스로 걸을 수 있음</label>
	<input type="radio" id="cw_assistance" name="state_mobility" value="지팡이 혹은 휠체어 보조 필요" >
		<label for="cw_assistance">지팡이 혹은 휠체어 보조 필요</label>
	<input type="radio" id="only_bed" name="state_mobility" value="침대에서만 움직임이 가능" >
		<label for="only_bed">침대에서만 움직임이 가능</label>
	<input type="radio" id="mobility_n" name="state_mobility" value="움직일 수 없음" checked>
...
<tr> <td>
<% if(bedsore_yn.equals("있음")) { %>
<input type="radio" id="b_yes" name="bedsore_yn" value="있음" checked>
		<label for="b_yes">있음</label>
	<input type="radio" id="b_no" name="bedsore_yn" value="없음">
		<label for="b_no">없음</label> <% } else { %>
<input type="radio" id="b_yes" name="bedsore_yn" value="있음" >
		<label for="b_yes">있음</label>
	<input type="radio" id="b_no" name="bedsore_yn" value="없음" checked>
...
<tr> <td>
<% if(care_night_yn.equals("예")) { %>
<input type="radio" id="caren_yes" name="care_night_yn" value="예" checked>
		<label for="caren_yes">예</label>
	<input type="radio" id="caren_no" name="care_night_yn" value="아니오">
		<label for="caren_no">아니오</label> <% } else { %>
<input type="radio" id="caren_yes" name="care_night_yn" value="예" >
		<label for="caren_yes">예</label>
	<input type="radio" id="caren_no" name="care_night_yn" value="아니오" checked>
...
<textarea id="notice" name="notice" cols="100" rows="3"><%=notice%></textarea>
