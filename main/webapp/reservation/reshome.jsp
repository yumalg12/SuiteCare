...
function check() {
	var f = document.homeForm;
	var addr = document.homeForm.addr.value;
	var detail_addr = document.homeForm.detail_addr.value;
...
<tr>
		...
		<td>
 		<input type="button" onclick="execDaumPostcode()" value="주소 찾기"><br>
					  <br>
					  <p> 
					   도로명 주소 <br><input type="text" id="addr"  name="addr" size="50"><br><br>
					   나머지 주소 <br><input type="text"  name="detail_addr" size="50" />
