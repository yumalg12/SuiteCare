						...
						<div>
							...
							<div class="form_button">
								...
								<% MatchDAO mdao = new MatchDAO();
									String mst = mdao.mst(res_code, g_id);
									if (!mst.equals("승인") && !mst.equals("거절")) { 
										out.print("<a href='./match?type=deny&g_id=" + g_id + "&res_code=" + res_code + "' class='button alt'>거절</a>");
										out.print("<a href='./match?type=approve&g_id=" + g_id + "&res_code=" + res_code + "' class='button special'>승인</a>");
									} %>
							</div>
						</div>
...
<script>
	...
	function close_w_reload(){
		...
		opener.parent.location="/suiteCare/caregiver/main";
		window.close();
	}
</script>