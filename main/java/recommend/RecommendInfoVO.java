...
public class RecommendInfoVO {
	...
	public RecommendInfoVO() {
		System.out.println("RecommendInfoVO");
	}
	...
	/**
	 * @param g_address the g_address to set
	 */
	...
	/**
	 * @param g_profile the g_profile to set
	 */
	...
	/**
	 * @param g_qualification the g_qualification to set
	 */
	...
	/**
	 * @param g_gender the g_gender to set
	 */
	...
	/**
	 * @param g_birth the g_birth to set
	 */
